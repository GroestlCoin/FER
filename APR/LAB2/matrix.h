...
class Matrix
{
  ...
  public:
    ...
    bool operator > (const Matrix&);              //operator vece (za sve)
    bool operator < (double);                     //operator manje (abs)
    
    
    inline int getR()const;                       //dohvacanje redaka
    inline int getC()const;                       //dohvacanje stupaca
